...
public:
    ...
    void setDefaultSettings(JNIEnv *env, jstring jSoundfontPath){
        ...
        fluid_settings_setnum(settings,"temp_synth.sample-rate",48000);
        fluid_settings_setint(settings,"audio.periods",2);
        fluid_settings_setint(settings,"audio.period-size",256);
        fluid_settings_setint(settings,"temp_synth.cpu-cores",8);
    ...
    void setRoomsize(float roomsize){
        ...
        fluid_settings_setnum(settings,"temp_synth.reverb.room-size",roomsize);
