...
/**
 * @file temp_settings.h
 * @brief Synthesizer temp_settings
 * @defgroup SettingsFunctions Functions for temp_settings management
 *
 * To create a synthesizer object you will have to specify its
 * temp_settings. These temp_settings are stored in a fluid_settings_t object.
 * @code
 *     void
 *     my_synthesizer ()
 *     {
 ...
 *       fluid_settings_setstr(temp_settings, "audio.driver", "alsa");
 *       // ... change temp_settings ...
